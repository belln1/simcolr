...
cartels_duration <- get_durations(sim_list$cartels, sim_list$detection, sim_list$leniency)
...
# cartels_duration <- get_durations(sim_list$cartels_detected, sim_list$cartels_undetected, parms, model=1)
# cartels_duration <- data.frame(cartels_duration)
